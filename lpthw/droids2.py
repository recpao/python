...
Vladimir Vitvitskiy 5 years, 11 months ago  # | flag
Hi cool that you have shared it. I suggest you to pay attention at code duplication when you display messages, for instance.

You can invent like own small language to focus on text not on print/sleep statements

In my example below _display function will print line by line, if needed strip leading spaces and when it meats #N in the end of line it make time.sleep for N seconds. In such way the module will be better focused on text not statements
